...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      ...
      '*epreselec*' EPRESELEC
      '*'           DEFAULT)
  typeset -g POWERLEVEL9K_AWS_FINKIN_FOREGROUND=lightgreen
  typeset -g POWERLEVEL9K_AWS_MICROEPRE_FOREGROUND=207  # violet
  typeset -g POWERLEVEL9K_AWS_EPRESELEC_FOREGROUND=yellow
